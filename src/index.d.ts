...
export interface VNode<P = Record<never, never>> {
...
export type Key = string | number | unknown;
...
export type RenderableProps<P, RefType = unknown> =
  & P
  & Readonly<Attributes & { children?: ComponentChildren; ref?: Ref<RefType> }>;

export type ComponentType<P = Record<never, never>> =
  | ComponentClass<P>
  | FunctionComponent<P>;
export type ComponentFactory<P = Record<never, never>> = ComponentType<P>;

export type ComponentProps<
  C extends ComponentType<unknown> | keyof JSXInternal.IntrinsicElements,
...
export interface FunctionComponent<P = Record<never, never>> {
  (props: RenderableProps<P>, context?: any): VNode<unknown> | null;
  displayName?: string;
